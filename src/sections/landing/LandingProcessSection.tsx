...
const LandingProcessSection: React.FC<IProcessTimeline> = ({ title, steps }) => {
  return (
    <Section bgColor='dark' textColor='light' className='py-32 relative overflow-hidden'>
      {/* Background Graphic */}
          ...
          {steps.map((step, idx) => (
            ...
            >
              <div className='flex items-center gap-4'>
                ...
                <div className='h-[1px] flex-grow bg-white/10 group-hover:bg-accent/30 transition-colors duration-500' />
              </div>
              
              <div className='flex flex-col gap-4'>
                <h3 className='text-h4 font-bebas text-light uppercase tracking-widest group-hover:text-accent transition-colors'>
                  {step.title}
                </h3>
