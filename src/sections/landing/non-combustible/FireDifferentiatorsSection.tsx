    ...
    <Section bgColor='dark' textColor='light' className='relative'>
      <div className='flex flex-col gap-14 md:gap-18'>
        <div className='flex flex-col md:flex-row md:justify-between md:items-end gap-8'>
          ...
          <LandingCtaLink
            href={cta.link}
            linkClassName='w-full md:w-auto md:mb-2 shrink-0'
          >
            {cta.text}
          </LandingCtaLink>
        </div>
          ...
          {items.map((item, idx) => (
            ...
            >
              <div className='flex justify-between items-start'>
                <span className='font-bebas text-accent text-3xl tracking-widest'>
                  0{idx + 1}
                </span>
              </div>
...
export default FireDifferentiatorsSection;
